...
class MCTS():
    ...
    def run(self, n=1, initial_configurations=[], nb_iter_to_generate_img=1, pb=None, status_txt=None, chart=None, status_txt2=None):
        ...
        for i in range(n):
            ...
            status_txt2.text(
                "最佳数据：%s\n最佳配置：%s" % (self.bestscore, self.bestconfig)
            )
            chart.add_rows(np.array([self.bestscore]))
